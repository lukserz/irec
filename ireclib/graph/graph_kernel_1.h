...
// ----------------------------------------------------------------------------------------
    ...
    { 
        ...
        )
        {
            ...
            IRECLIB_CASSERT(edge_index < self.number_of_neighbors(),
        ...
        {
            // make sure requires clause is not broken
            IRECLIB_CASSERT(index < self.number_of_nodes(),
        ...
        {
            // make sure requires clause is not broken
            IRECLIB_CASSERT(node_index1 < self.number_of_nodes() &&
        ...
        )
        {
            ...
            IRECLIB_CASSERT( self.has_edge(node_index1, node_index2) == false,
                          "\tvoid graph::add_edge(node_index1, node_index2)"
        ...
        )
        {
            ...
            IRECLIB_CASSERT( self.has_edge(node_index1, node_index2) == true,
                          "\tvoid graph::remove_edge(node_index1, node_index2)"
