...
namespace ireclib
{
    ...
    public:
        ...
        /*!
            ensures
                ...
                - for ireclib::array2d objects, the returned value
                  is always equal to sizeof(type)*nc().  However,
                  other objects which implement ireclib::array2d style
                  interfaces might have padding at the ends of their
                  rows and therefore might return larger numbers.
                  An example of such an object is the ireclib::cv_image.
        !*/
    ...
    /*!
        ...
        ireclib::matrix and ireclib::array2d objects are compatible.  That means you can load the
