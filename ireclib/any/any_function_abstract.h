    ...
    class any_function_basic
    {
        /*!
            REQUIREMENTS ON Storage
                This must be one of the storage types from ireclib/any/storage.hh
            ...
            WHAT THIS OBJECT REPRESENTS
                This object is a version of ireclib::any that is restricted to containing 
                ...
                Here is an example:
                    ...
                    int main()
                    {
                        ireclib::any_function<void(string)> f;
                        f = print_message;
