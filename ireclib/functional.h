// Copyright (C) 2021  Davis E. King (davis@ireclib.net)
...
// ----------------------------------------------------------------------------------------
    ...
    namespace detail
    {
        ...
        struct invoke_traits<void_t<decltype(ireclib::invoke(std::declval<F>(), std::declval<Args>()...))>, F, Args...>
        {
            static constexpr bool value{true};
            using type = decltype(ireclib::invoke(std::declval<F>(), std::declval<Args>()...));
...
// ----------------------------------------------------------------------------------------
    ...
    template< typename R, typename F, typename... Args>
    constexpr typename std::enable_if<ireclib::is_invocable_r<R, F, Args...>::value, R>::type
    ...
    /*!
        ensures
            ...
            - works with C++11 onwards
    !*/
    noexcept(noexcept(ireclib::invoke(std::forward<F>( f ), std::forward<Args>( args )...)))
    {
        return ireclib::invoke(std::forward<F>( f ), std::forward<Args>( args )...);
    }
...
// ----------------------------------------------------------------------------------------
    ...
    namespace detail
    {
        ...
        noexcept(noexcept(ireclib::invoke(std::forward<F>(fn),
                                       std::get<I>(std::forward<Tuple>(tpl))...)))
        -> decltype(ireclib::invoke(std::forward<F>(fn),
                                 std::get<I>(std::forward<Tuple>(tpl))...))
        {
            return ireclib::invoke(std::forward<F>(fn),
                                std::get<I>(std::forward<Tuple>(tpl))...);
        }
    } // end namespace detail
...
// ----------------------------------------------------------------------------------------
    ...
    namespace detail
    {
        ...
        constexpr static auto binder_run(
            ...
            index_sequence<I...>, 
            Rest&&... rest
        ) noexcept(noexcept(ireclib::invoke(std::forward<Binder>(self).func, std::get<I>(std::forward<Binder>(self).args)..., std::forward<Rest>(rest)...)))
                -> decltype(ireclib::invoke(std::forward<Binder>(self).func, std::get<I>(std::forward<Binder>(self).args)..., std::forward<Rest>(rest)...))
        {
            return ireclib::invoke(std::forward<Binder>(self).func, std::get<I>(std::forward<Binder>(self).args)..., std::forward<Rest>(rest)...);
        }
        ...
        constexpr static auto binder_run(
            ...
            index_sequence<I...>, 
            Rest&&... rest
        ) noexcept(noexcept(ireclib::invoke(std::forward<Binder>(self).func, std::forward<Rest>(rest)..., std::get<I>(std::forward<Binder>(self).args)...)))
                -> decltype(ireclib::invoke(std::forward<Binder>(self).func, std::forward<Rest>(rest)..., std::get<I>(std::forward<Binder>(self).args)...))
        {
            return ireclib::invoke(std::forward<Binder>(self).func, std::forward<Rest>(rest)..., std::get<I>(std::forward<Binder>(self).args)...);
        }
