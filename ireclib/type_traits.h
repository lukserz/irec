...
/*
    ...
    deprecate old ireclib type traits.
*/
...
// ----------------------------------------------------------------------------------------
    ...
    /*!A basic_type
        ...
        This is the same as remove_cvref_t and exists for backwards compatibility with older ireclib clients,
        since basic_type has existed in ireclib long before remove_cvref_t was added to the standard library.
    !*/
    template <typename T>
...
// ----------------------------------------------------------------------------------------
    ...
    namespace details
    {
        ...
        struct is_detected_impl<ireclib::void_t<Op<Args...>>, Op, Args...> : std::true_type {};
    }
