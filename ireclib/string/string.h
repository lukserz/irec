...
// ----------------------------------------------------------------------------------------
    ...
    IRECLIB_STRING_CAST_INTEGRAL(unsigned short)
    IRECLIB_STRING_CAST_INTEGRAL(short)
    IRECLIB_STRING_CAST_INTEGRAL(unsigned int)
    IRECLIB_STRING_CAST_INTEGRAL(int)
    IRECLIB_STRING_CAST_INTEGRAL(unsigned long)
    IRECLIB_STRING_CAST_INTEGRAL(long)
    IRECLIB_STRING_CAST_INTEGRAL(uint64)
...
// ----------------------------------------------------------------------------------------
    ...
    {
        IRECLIB_ASSERT ( first_pad < max_per_line && rest_pad < max_per_line && 
                 rest_pad >= first_pad,
                 "\tconst std::basic_string<charT,traits,alloc> wrap_string()"
                 << "\n\tfirst_pad:    " << first_pad
                 << "\n\trest_pad:     " << rest_pad
