...
// ----------------------------------------------------------------------------------------
    ...
    public:
        ...
        )
        {
            ...
            // since the ireclib state that maintains the registered thread end handlers may have
    ...
    private:
        ...
        ) const
        {
            ...
            {
                // register an end handler for this thread so long as it is a ireclib created thread.
                T* new_item = new T;
