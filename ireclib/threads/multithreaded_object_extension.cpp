...
// ----------------------------------------------------------------------------------------
    ...
    )
    {
        try
        {
            IRECLIB_ASSERT(number_of_threads_alive() == 0,
...
// ----------------------------------------------------------------------------------------
    ...
    ) const
    {
        ...
        IRECLIB_ASSERT(thread_ids.is_in_domain(get_thread_id()) == false,
...
// ----------------------------------------------------------------------------------------
    ...
    {
        auto_mutex M(m_);
        IRECLIB_ASSERT(thread_ids.is_in_domain(get_thread_id()),
