...
// ----------------------------------------------------------------------------------------
    ...
    /*!
        THREAD POOLING
            ...
            of view a thread terminates/ends when it returns to the ireclib thread pool and you 
            ...
            IRECLIB_THREAD_POOL_TIMEOUT to whatever value (in milliseconds) that you like.
...
// ----------------------------------------------------------------------------------------
    ...
    /*!
        requires
            ...
            - is_ireclib_thread() == true (i.e. the calling thread was spawned by ireclib::create_new_thread())
        ensures
