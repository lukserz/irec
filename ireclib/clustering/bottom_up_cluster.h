...
// ----------------------------------------------------------------------------------------
    ...
    )
    {
        ...
        IRECLIB_CASSERT(dists.nr() == dists.nc() && min_num_clusters > 0, 
            "\t unsigned long bottom_up_cluster()"
...
// ----------------------------------------------------------------------------------------
    ...
    struct snl_range
    {
        ...
        snl_range(double l, double u) : lower(l), upper(u) { IRECLIB_ASSERT(lower <= upper)}
...
// ----------------------------------------------------------------------------------------
    ...
    {
        IRECLIB_CASSERT(max_range_width >= 0);
