// Copyright (C) 2024  Davis E. King (davis@ireclib.net), Adrià Arrufat
// License: Boost Software License   See LICENSE.txt for the full license.

// only do anything with this file if IRECLIB_JXL_SUPPORT is defined
...
// ----------------------------------------------------------------------------------------
    ...
    jxl_loader::
    jxl_loader(const ireclib::file& f) : height(0), width(0)
    {
