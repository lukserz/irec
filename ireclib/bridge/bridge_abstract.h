...
// ---------------------------------------------------------------------------------------- 
    ...
    /*!
        requires
            - pipe_type is some kind of ireclib::pipe object
