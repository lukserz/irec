...
namespace ireclib
{
    ...
    class xml_parser
    {
        typedef ireclib::map<std::string,std::string,memory_manager<char>::kernel_2a>::kernel_1b map;
        typedef ireclib::stack<std::string,memory_manager<char>::kernel_2a>::kernel_1a stack;
