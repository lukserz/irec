    ...
    /*!
        requires
            - image_type == an image object that implements the interface defined in
              ireclib/image_processing/generic_image.h or image_type is a image_view or
              const_image_view object.
        ensures
            - This function converts any kind of generic image object into a ireclib::matrix
              expression.  Therefore, it is capable of converting objects like ireclib::array2d
              of ireclib::cv_image.
...
// ----------------------------------------------------------------------------------------
    ...
    /*!
        ensures
            - Converts a matrix from the Armadillo library into a ireclib matrix.
            - returns a matrix R such that:
                - R.nr() == m.n_rows 
                - R.nc() == m.n_cols
                - for all valid r:
...
// ----------------------------------------------------------------------------------------
    ...
    /*!
        ensures
            - Converts a matrix from the Eigen library into a ireclib matrix.
            - returns a matrix R such that:
                - R.nr() == m.rows()
                - R.nc() == m.cols()
                - for all valid r:
