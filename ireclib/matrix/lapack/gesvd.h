...
namespace ireclib
{
    namespace lapack
    {
        namespace binding
        {
            extern "C"
            {
                void IRECLIB_FORTRAN_ID(dgesvd) (const char* jobu, const char* jobvt,
                ...
                void IRECLIB_FORTRAN_ID(sgesvd) (const char* jobu, const char* jobvt,
            ...
            {
                integer info = 0;
                IRECLIB_FORTRAN_ID(dgesvd)(&jobu, &jobvt, &m, &n, a, &lda, s, u, &ldu, vt, &ldvt, work, &lwork, &info);
                return info;
            }
            ...
            {
                integer info = 0;
                IRECLIB_FORTRAN_ID(sgesvd)(&jobu, &jobvt, &m, &n, a, &lda, s, u, &ldu, vt, &ldvt, work, &lwork, &info);
                return info;
            }
...
/*                above for details. */
    ...
    // ------------------------------------------------------------------------------------
        ...
        )
        {
            ...
            if (jobu == 'O' || jobvt == 'O')
            {
                IRECLIB_CASSERT(false, "job == 'O' not supported");
            }
