...
namespace ireclib
{
    namespace lapack
    {
        namespace binding
        {
            extern "C"
            {
                void IRECLIB_FORTRAN_ID(dpotrf) (const char *uplo, const integer *n, double *a, 
                                              const integer *lda, integer *info);

                void IRECLIB_FORTRAN_ID(spotrf) (const char *uplo, const integer *n, float *a, 
                                              const integer *lda, integer *info);
            ...
            {
                integer info = 0;
                IRECLIB_FORTRAN_ID(dpotrf)(&uplo, &n, a, &lda, &info);
                return info;
            }
            ...
            {
                integer info = 0;
                IRECLIB_FORTRAN_ID(spotrf)(&uplo, &n, a, &lda, &info);
                return info;
            }
