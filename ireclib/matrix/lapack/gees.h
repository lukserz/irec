...
namespace ireclib
{
    namespace lapack
    {
        namespace binding
        {
            ...
            extern "C"
            {
                void IRECLIB_FORTRAN_ID(dgees) (const char *jobvs, const char *sort, const L_fp select, const integer *n, 
                ...
                void IRECLIB_FORTRAN_ID(sgees) (const char *jobvs, const char *sort, const L_fp select, const integer *n, 
                             ...
                             integer lwork)
            {
                ...
                logical bwork = 0;
                integer sdim = 0;
                IRECLIB_FORTRAN_ID(dgees)(&jobvs, &sort, fnil, &n,
                                       a, &lda, &sdim, wr,
                                       wi, vs, &ldvs, work,
                                       &lwork, &bwork, &info);
                return info;
                             ...
                             integer lwork)
            {
                ...
                logical bwork = 0;
                integer sdim = 0;
                IRECLIB_FORTRAN_ID(sgees)(&jobvs, &sort, fnil, &n,
                                       a, &lda, &sdim, wr,
                                       wi, vs, &ldvs, work,
                                       &lwork, &bwork, &info);
                return info;
