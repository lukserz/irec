...
namespace ireclib
{
    namespace lapack
    {
        namespace binding
        {
            extern "C"
            {
                void IRECLIB_FORTRAN_ID(dsyev) (const char *jobz, const char *uplo, const integer *n, double *a,
                                             const integer *lda, double *w, double *work, const integer *lwork, 
                                             integer *info);

                void IRECLIB_FORTRAN_ID(ssyev) (const char *jobz, const char *uplo, const integer *n, float *a,
            ...
            {
                integer info = 0;
                IRECLIB_FORTRAN_ID(dsyev)(&jobz, &uplo, &n, a,
            ...
            {
                integer info = 0;
                IRECLIB_FORTRAN_ID(ssyev)(&jobz, &uplo, &n, a,
                                       &lda, w, work, &lwork, &info);
                return info;
            }
