...
namespace ireclib
{
    namespace lapack
    {
        namespace binding
        {
            extern "C"
            {
                void IRECLIB_FORTRAN_ID(dgesdd) (char const* jobz, 
                ...
                void IRECLIB_FORTRAN_ID(sgesdd) (char const* jobz, 
            ...
            {
                integer info = 0;
                IRECLIB_FORTRAN_ID(dgesdd)(&jobz, &m, &n, a, &lda, s, u, &ldu, vt, &ldvt, work, &lwork, iwork, &info);
                return info;
            }
            ...
            {
                integer info = 0;
                IRECLIB_FORTRAN_ID(sgesdd)(&jobz, &m, &n, a, &lda, s, u, &ldu, vt, &ldvt, work, &lwork, iwork, &info);
                return info;
            }
        }
...
/*     California at Berkeley, USA */
    ...
    // ------------------------------------------------------------------------------------
        ...
        )
        {
            ...
            {
                IRECLIB_CASSERT(false, "jobz == 'O' not supported");
            }
            else
            {
