...
namespace ireclib
{
    namespace lapack
    {
        namespace binding
        {
            extern "C"
            {
                void IRECLIB_FORTRAN_ID(dgetrf) (const integer *m, const integer *n, double *a, 
                                              const integer *lda, integer *ipiv, integer *info);

                void IRECLIB_FORTRAN_ID(sgetrf) (const integer *m, const integer *n, float *a, 
                                              const integer *lda, integer *ipiv, integer *info);
            ...
            {
                integer info = 0;
                IRECLIB_FORTRAN_ID(dgetrf)(&m, &n, a, &lda, ipiv, &info);
                return info;
            }
            ...
            {
                integer info = 0;
                IRECLIB_FORTRAN_ID(sgetrf)(&m, &n, a, &lda, ipiv, &info);
                return info;
            }
