...
namespace ireclib
{
    namespace lapack
    {
        namespace binding
        {
            extern "C"
            {
                void IRECLIB_FORTRAN_ID(dpbtrf) (const char *uplo, const integer *n, const integer *kd,
                                              double *ab, const integer *ldab, integer *info);

                void IRECLIB_FORTRAN_ID(spbtrf) (const char *uplo, const integer *n, const integer *kd,
            ...
            {
                integer info = 0;
                IRECLIB_FORTRAN_ID(dpbtrf)(&uplo, &n, &kd, ab, &ldab, &info);
                return info;
            }
            ...
            {
                integer info = 0;
                IRECLIB_FORTRAN_ID(spbtrf)(&uplo, &n, &kd, ab, &ldab, &info);
                return info;
            }
        }
