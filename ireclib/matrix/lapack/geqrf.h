...
namespace ireclib
{
    namespace lapack
    {
        namespace binding
        {
            extern "C"
            {
                void IRECLIB_FORTRAN_ID(dgeqrf) (const integer *m, const integer *n, double *a, const integer*
                                              lda, double *tau, double *work, const integer *lwork, 
                                              integer *info);

                void IRECLIB_FORTRAN_ID(sgeqrf) (const integer *m, const integer *n, float *a, const integer*
            ...
            {
                integer info = 0;
                IRECLIB_FORTRAN_ID(dgeqrf)(&m, &n, a, &lda,
                                        tau, work, &lwork, &info);
                return info;
            }
            ...
            {
                integer info = 0;
                IRECLIB_FORTRAN_ID(sgeqrf)(&m, &n, a, &lda,
                                        tau, work, &lwork, &info);
                return info;
            }
