...
// ----------------------------------------------------------------------------------------
    ...
    {
        IRECLIB_ASSERT(r >= 0 && c >= 0 && nr >= 0 && nc >= 0 && r+nr <= m.nr() && c+nc <= m.nc(), 
...
// ----------------------------------------------------------------------------------------
    ...
    {
        IRECLIB_ASSERT(get_rect(m).contains(rect) == true, 
...
// ----------------------------------------------------------------------------------------
    ...
    )
    {
        ...
        IRECLIB_ASSERT(0 <= min(rows) && max(rows) < m.nr() && 0 <= min(cols) && max(cols) < m.nc() &&
...
// ----------------------------------------------------------------------------------------
    ...
    )
    {
        ...
        if (rows.size() != 0) {
            IRECLIB_ASSERT(0 <= min(rows) && max(rows) < m.nr() && (rows.nr() == 1 || rows.nc() == 1), 
...
// ----------------------------------------------------------------------------------------
    ...
    )
    {
        ...
        if (cols.size() != 0) {
            IRECLIB_ASSERT(0 <= min(cols) && max(cols) < m.nc() && (cols.nr() == 1 || cols.nc() == 1), 
...
// ----------------------------------------------------------------------------------------
    ...
    public:
        ...
        ) 
        {
            ...
            IRECLIB_ASSERT( exp.nr() == height && exp.nc() == width,
...
// ----------------------------------------------------------------------------------------
    ...
    public:
        ...
        {
            IRECLIB_ASSERT( exp.nr() == rows.size() && exp.nc() == cols.size(),
...
// ----------------------------------------------------------------------------------------
    ...
    public:
        ...
        {
            IRECLIB_ASSERT( exp.nc() == 1 && exp.nr() == m.nr(),
...
// ----------------------------------------------------------------------------------------
    ...
    public:
        ...
        {
            IRECLIB_ASSERT( exp.nr() == 1 && exp.nc() == m.nc(),
