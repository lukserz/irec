...
// ----------------------------------------------------------------------------------------
    ...
    public:
            ...
            rhs(rhs_)
        {
            ...
            IRECLIB_ASSERT(lhs.nc() == rhs.nr() && lhs.size() > 0 && rhs.size() > 0, 
...
// ----------------------------------------------------------------------------------------
    ...
    public:
        ...
        {
            IRECLIB_ASSERT( (NR == 0 || NR == rows) && ( NC == 0 || NC == cols) && 
                    rows >= 0 && cols >= 0, 
        ...
        )
        {
            ...
            IRECLIB_ASSERT((NR == 0 || NR == m.nr()) && (NC == 0 || NC == m.nc()), 
    ...
    private:
        struct literal_assign_helper
        {
            /*
                ...
                used primarily to enable us to put IRECLIB_CASSERT statements on the usage of the
            ...
            */
            ...
            {
                IRECLIB_CASSERT(!has_been_used || r == (*m).nr(),
...
// ----------------------------------------------------------------------------------------
    ...
    )
    {
        try
        {
            ...
            // ireclib while also encoding things in a way that lets the array2d and matrix
        ...
        {
            throw serialization_error(e.info + "\n   while serializing ireclib::matrix");
        }
    }
    ...
    )
    {
        try
        {
            ...
            if (NR != 0 && nr != NR)
                throw serialization_error("Error while deserializing a ireclib::matrix.  Invalid rows");
            if (NC != 0 && nc != NC)
                throw serialization_error("Error while deserializing a ireclib::matrix.  Invalid columns");
        ...
        {
            throw serialization_error(e.info + "\n   while deserializing a ireclib::matrix");
        }
    }
