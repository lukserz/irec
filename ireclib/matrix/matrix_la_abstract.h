...
// ----------------------------------------------------------------------------------------
    ...
    /*!
        ensures
            ...
            - #v.nr() == m.nc()
            - #v.nc() == m.nc()
            - if IRECLIB_USE_LAPACK is #defined then the xGESVD routine
...
// ----------------------------------------------------------------------------------------
    ...
    /*!
        ...
        ensures
            ...
            - if (IRECLIB_USE_LAPACK is #defined) then 
                - if (withu == withv) then
...
// ----------------------------------------------------------------------------------------
    ...
    /*!
        requires
            - A contains a set of sparse vectors.  See ireclib/svm/sparse_vector_abstract.h
...
// ----------------------------------------------------------------------------------------
    ...
    /*!
        ...
        ensures
            ...
            - If IRECLIB_USE_LAPACK is defined then the LAPACK routine xPOTRF 
    ...
    class lu_decomposition
    {
        /*!
            REQUIREMENTS ON matrix_exp_type
                ...
                ireclib/matrix/matrix_abstract.h file.   (e.g. a ireclib::matrix object)
            ...
            WHAT THIS OBJECT REPRESENTS
                ...
                If IRECLIB_USE_LAPACK is defined then the LAPACK routine xGETRF 
    ...
    class qr_decomposition 
    {
        /*! 
            ...
            WHAT THIS OBJECT REPRESENTS
                ...
                If IRECLIB_USE_LAPACK is #defined then the xGEQRF routine
        ...
        /*!
            ...
            WHAT THIS OBJECT REPRESENTS
                ...
                then:
                    ...
                    - V*trans(V) should be equal to the identity matrix.  That is, all the
                      eigenvectors in V should be orthonormal. 
                        - So A == V*D*trans(V)
                    - If IRECLIB_USE_LAPACK is #defined then this object uses the xSYEVR LAPACK
                      routine.
                ...
                On the other hand, if A is not symmetric then:
                    ...
                    - If IRECLIB_USE_LAPACK is #defined then this object uses the xGEEV LAPACK
                      routine.
        !*/
    ...
    public:
        ...
        /*!
            ...
            ensures
                ...
                ireclib::make_symmetric() function.  This function simply reflects
