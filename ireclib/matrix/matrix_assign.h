...
// ----------------------------------------------------------------------------------------
    ...
    // ------------------------------------------------------------------------------------
        ...
        struct matrix_assign_blas_helper
        {
            ...
            // default ireclib matrix multiply to speed things up a bit more
    ...
    template <typename T, typename L> struct IRECLIB_BOOST_JOIN(blas,__LINE__)                      \
    ...
    typename enable_if<IRECLIB_BOOST_JOIN(blas,__LINE__)<src_exp,typename dest_exp::layout_type> >::type > {   \
        static void assign (                                                                \
            dest_exp& dest,                                                                \
            const src_exp& src,                                                             \
            typename src_exp::type alpha,                                                   \
            bool add_to,                                                                    \
            bool IRECLIB_NO_WARN_UNUSED transpose                      \
        ) {                                                                                 \
            IRECLIB_NO_WARN_UNUSED typedef typename dest_exp::type T;                                             
