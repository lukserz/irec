    ...
    class error : public std::exception
    {
        /*!
            WHAT THIS OBJECT REPRESENTS
                This is the base exception class for the ireclib library.  i.e. all 
...
// ----------------------------------------------------------------------------------------
    ...
    class fatal_error : public error
    {
        /*!
            WHAT THIS OBJECT REPRESENTS
                ...
                This is also the exception thrown by the IRECLIB_ASSERT and IRECLIB_CASSERT macros.
        !*/
    ...
    private:
        ...
        static inline void ireclib_fatal_error_terminate (
        )
        {
        ...
        {
            // If ireclib is being use to create plugins for some other application, like
            ...
            {
                // copy the message into the fixed message buffer so that it can be recalled by ireclib_fatal_error_terminate
                // if needed.
                char* msg = message();
                unsigned long i;
                ...
                // set this termination handler so that if the user doesn't catch this ireclib::fatal_error that is being
                // thrown then it will eventually be printed to standard error
                std::set_terminate(&ireclib_fatal_error_terminate);
            }
...
// ----------------------------------------------------------------------------------------
    ...
    class impossible_labeling_error : public ireclib::error 
    { 
        /*!
            WHAT THIS OBJECT REPRESENTS
        ...
        !*/
    public: 
        impossible_labeling_error(const std::string& msg) : ireclib::error(msg) {};
    };
