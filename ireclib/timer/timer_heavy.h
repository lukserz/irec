    ...
    class timer_heavy
    {
        /*!
            WHAT THIS OBJECT REPRESENTS
                ...
                ireclib::timer was a multi-implementation component and the timer_heavy was
                its first implementation.  It was superseded later by the more efficient
                ireclib::timer.  However, timer_heavy is still around so that
                ireclib::timer::kernel_1a has something to refer to.  This way, old client
...
// ----------------------------------------------------------------------------------------
    ...
    )
    {
        ...
        if (running == false)
        {
            ...
            {
                running = false;
                throw ireclib::thread_error("error creating new thread in timer_heavy::start");
            }
        }
    }
