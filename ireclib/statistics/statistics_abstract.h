...
// ----------------------------------------------------------------------------------------
    ...
    class running_covariance
    {
        /*!
            REQUIREMENTS ON matrix_type
                Must be some type of ireclib::matrix.
    ...
    public:
        ...
        /*!
            requires
                - val must represent a column vector.  It can either be a ireclib::matrix
                  object or some kind of unsorted sparse vector type.  See the top of
                  ireclib/svm/sparse_vector_abstract.h for a definition of unsorted sparse vector.
                - val must have a number of dimensions which is compatible with the current
                  ...
                  following must hold:
                    - if (val is a ireclib::matrix) then 
...
// ----------------------------------------------------------------------------------------
    ...
    public:
        ...
        /*!
            requires
                - x and y must represent column vectors.  They can either be ireclib::matrix
...
// ----------------------------------------------------------------------------------------
    ...
    class vector_normalizer
    {
        /*!
            REQUIREMENTS ON matrix_type
                - must be a ireclib::matrix object capable of representing column 
                  vectors
