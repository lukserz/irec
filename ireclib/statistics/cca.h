...
// ----------------------------------------------------------------------------------------
    ...
    {
        IRECLIB_ASSERT( L.size() > 0 && R.size() > 0 && L.nr() == R.nr(), 
...
// ----------------------------------------------------------------------------------------
    ...
    {
        IRECLIB_ASSERT( num_correlations > 0 && L.size() > 0 && R.size() > 0 && L.nr() == R.nr() &&
            regularization >= 0, 
            "\t matrix cca()"
            << "\n\t Invalid inputs were given to this function."
...
// ----------------------------------------------------------------------------------------
    ...
    {
        IRECLIB_ASSERT( num_correlations > 0 && L.size() == R.size() && 
