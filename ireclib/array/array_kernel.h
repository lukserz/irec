...
namespace ireclib
{
    ...
    public:
        ...
        // These typedefs are here for backwards compatibility with old versions of ireclib.
...
// ----------------------------------------------------------------------------------------
    ...
    {
        // make sure requires clause is not broken
        IRECLIB_CASSERT(( size <= this->max_size() ),
            "\tvoid array::set_size"
...
// ----------------------------------------------------------------------------------------
    ...
    {
        // make sure requires clause is not broken
        IRECLIB_ASSERT(this->current_element_valid(),
