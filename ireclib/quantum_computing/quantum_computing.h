...
// ----------------------------------------------------------------------------------------
    ...
    public:
        ...
        )
        {
            ...
            IRECLIB_CASSERT(1 <= num_bits && num_bits <= 30,
        ...
        {
            // make sure requires clause is not broken
            IRECLIB_CASSERT(0 <= bit && bit < num_bits(),
        ...
        {
            // make sure requires clause is not broken
            IRECLIB_CASSERT(0 <= bit && bit < num_bits() && num_bits() > 0,
...
// ----------------------------------------------------------------------------------------
    ...
    public:
        ...
        {
            // make sure requires clause is not broken
            IRECLIB_CASSERT(reg.num_bits() == num_bits,
        ...
        {
            // make sure requires clause is not broken
            IRECLIB_ASSERT(reg.nr() == dims && reg.nc() == 1 && 
