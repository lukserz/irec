        ...
        )
        {
            ...
            IRECLIB_CASSERT(img.size() != 0,
                ...
                /* !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
                    ...
                    but you haven't defined IRECLIB_PNG_SUPPORT.  You must do so to use
            ...
            {
                IRECLIB_CASSERT(pixel_traits<pixel_type>::grayscale, "impossible condition detected");
                ...
                else
                {
                    ...
                    array2d<ireclib::uint16> temp_img;
                    assign_image(temp_img, img_);
                    for (unsigned long i = 0; i < row_pointers.size(); ++i)
                        row_pointers[i] = (unsigned char*)(&temp_img[i][0]);
