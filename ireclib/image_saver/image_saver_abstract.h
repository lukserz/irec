...
namespace ireclib
{
    class image_save_error : public ireclib::error 
    { 
        /*!
    ...
    /*!
        requires
            - image_type == an image object that implements the interface defined in
              ireclib/image_processing/generic_image.h or any kind of matrix expression.
        ensures
...
// ----------------------------------------------------------------------------------------
    ...
    /*!
        ireclib dng file format:
            ...
            the ireclib PPM compression algorithms instead of the DEFLATE algorithm.
    !*/
    ...
    /*!
        requires
            - image_type == an image object that implements the interface defined in
              ireclib/image_processing/generic_image.h or any kind of matrix expression.
        ensures
            - writes the image to the out stream in the ireclib dng format.
            - image[0][0] will be in the upper left corner of the image.
            - image[image.nr()-1][image.nc()-1] will be in the lower right
              corner of the image.
