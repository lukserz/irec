...
// ----------------------------------------------------------------------------------------
    ...
    )
    {
        ...
        IRECLIB_CASSERT(( this->is_in_write_mode() == false ) && ( this->is_in_read_mode() == false ), 
...
// ----------------------------------------------------------------------------------------
    ...
    )
    {
        ...
        // make sure requires clause is not broken
        IRECLIB_CASSERT(( this->is_in_write_mode() == true ) || ( this->is_in_read_mode() == true ), 
...
// ----------------------------------------------------------------------------------------
    ...
    {
        // make sure requires clause is not broken
        IRECLIB_CASSERT(( this->is_in_write_mode() == true ) && ( bit == 0 || bit == 1 ), 
...
// ----------------------------------------------------------------------------------------
    ...
    )
    {
        ...
        // make sure requires clause is not broken
        IRECLIB_CASSERT(( this->is_in_read_mode() == true ), 
