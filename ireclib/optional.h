// Copyright (C) 2023  Davis E. King (davis@ireclib.net)
...
// ---------------------------------------------------------------------------------------------------
    ...
    namespace details
    {
        ...
        template<class T>
        struct is_optional<ireclib::optional<T>> : std::true_type{};

        template<class T, class U>
        using is_constructible_from = And<
            !std::is_constructible<T,       ireclib::optional<U>&>::value,
            !std::is_constructible<T, const ireclib::optional<U>&>::value,
            !std::is_constructible<T,       ireclib::optional<U>&&>::value,
            !std::is_constructible<T, const ireclib::optional<U>&&>::value,
            !std::is_convertible<      ireclib::optional<U>&, T>::value,
            !std::is_convertible<const ireclib::optional<U>&, T>::value,
            !std::is_convertible<      ireclib::optional<U>&&, T>::value,
            !std::is_convertible<const ireclib::optional<U>&&, T>::value
        >;
        ...
        using is_assignable_from = And<
            ...
            std::is_assignable<T&,       ireclib::optional<U>&>::value,
            std::is_assignable<T&, const ireclib::optional<U>&>::value,
            std::is_assignable<T&,       ireclib::optional<U>&&>::value,
            std::is_assignable<T&, const ireclib::optional<U>&&>::value
        >;
        ...
        using is_construct_convertible_from = std::enable_if_t<
            ...
            !std::is_same<U_, ireclib::optional<T>>::value,
            bool
        >;
...
// ---------------------------------------------------------------------------------------------------
    ...
    public:
        ...
        void swap(optional& rhs) noexcept(std::is_nothrow_move_constructible<T>::value &&
                                          ireclib::is_nothrow_swappable<T>::value) 
        {
            using std::swap;
        ...
        template <
          class F,
          class Return = ireclib::remove_cvref_t<ireclib::invoke_result_t<F,T&>>,
          std::enable_if_t<details::is_optional<Return>::value, bool> = true
        >
        constexpr auto and_then(F&& f) &
        {
            if (*this)
                return ireclib::invoke(std::forward<F>(f), **this);
            else
                return Return{};
        }
        ...
        template <
          class F,
          class Return = ireclib::remove_cvref_t<ireclib::invoke_result_t<F,const T&>>,
          std::enable_if_t<details::is_optional<Return>::value, bool> = true
        >
        ...
        {
            if (*this)
                return ireclib::invoke(std::forward<F>(f), std::move(**this));
            else
                return Return{};
        }
        ...
        template <
          class F,
          class U = ireclib::remove_cvref_t<ireclib::invoke_result_t<F, T&>>,
          std::enable_if_t<!std::is_same<U, ireclib::in_place_t>::value, bool> = true,
          std::enable_if_t<!std::is_same<U, ireclib::nullopt_t>::value, bool> = true
        >
        constexpr ireclib::optional<U> transform(F&& f) &
        {
            if (*this)
                return ireclib::invoke(std::forward<F>(f), **this);
            else
                return ireclib::optional<U>{};
        }

        template <
          class F,
          class U = ireclib::remove_cvref_t<ireclib::invoke_result_t<F, const T&>>,
          std::enable_if_t<!std::is_same<U, ireclib::in_place_t>::value, bool> = true,
          std::enable_if_t<!std::is_same<U, ireclib::nullopt_t>::value, bool> = true
        >
        constexpr ireclib::optional<U> transform(F&& f) const&
        {
            if (*this)
                return ireclib::invoke(std::forward<F>(f), **this);
            else
        ...
        template < 
          class F,
          class U = ireclib::remove_cvref_t<ireclib::invoke_result_t<F>>,
          std::enable_if_t<std::is_same<U, ireclib::optional<T>>::value, bool> = true
        >
...
// ---------------------------------------------------------------------------------------------------
    ...
    template <
        ...
        ireclib::is_swappable<T>::value,
        bool> = true
    >
    void swap(ireclib::optional<T>& lhs, ireclib::optional<T>& rhs) noexcept(noexcept(lhs.swap(rhs))) 
    {
        return lhs.swap(rhs);
    }
...
// ---------------------------------------------------------------------------------------------------
    ...
    template< class T >
    constexpr ireclib::optional<std::decay_t<T>> make_optional( T&& value )
    {
        return ireclib::optional<std::decay_t<T>>(std::forward<T>(value));
    }

    template< class T, class... Args >
    constexpr ireclib::optional<T> make_optional( Args&&... args )
    {
        return ireclib::optional<T>(ireclib::in_place, std::forward<Args>(args)...);
    }

    template< class T, class U, class... Args >
    constexpr ireclib::optional<T> make_optional( std::initializer_list<U> il, Args&&... args )
    {
        return ireclib::optional<T>(ireclib::in_place, il, std::forward<Args>(args)...);
    }
