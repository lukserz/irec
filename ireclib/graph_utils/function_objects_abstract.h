    ...
    struct squared_euclidean_distance
    {
        /*!
            WHAT THIS OBJECT REPRESENTS
                ...
                between two ireclib::matrix objects. 
        ...
        /*!
            requires
                - sample_type should be a kind of ireclib::matrix 
            ensures
...
// ----------------------------------------------------------------------------------------
    ...
    struct cosine_distance 
    {
        ...
        /*!
            requires
                - sample_type is a dense vector (e.g. a ireclib::matrix) or a sparse
                  vector as defined at the top of ireclib/svm/sparse_vector_abstract.h
            ensures
...
// ----------------------------------------------------------------------------------------
    ...
    struct use_gaussian_weights 
    {
        /*!
            WHAT THIS OBJECT REPRESENTS
                This is a simple function object that takes a single argument
                which should be an object similar to ireclib::sample_pair.  
        ...
        /*!
            requires
                - e.distance() must be a valid expression that returns a number
                  (e.g. edge_type might be ireclib::sample_pair)
            ensures
