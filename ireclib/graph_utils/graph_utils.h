...
// ----------------------------------------------------------------------------------------
    ...
    )
    {
        ...
        IRECLIB_ASSERT(g.has_edge(idx_i,idx_j) == true,
...
// ----------------------------------------------------------------------------------------
    ...
    {
        // make sure requires clause is not broken
        IRECLIB_ASSERT(g.has_edge(parent_idx,child_idx) == true,
...
// ----------------------------------------------------------------------------------------
    ...
    {
        // make sure requires clause is not broken
        IRECLIB_ASSERT(graph_contains_directed_cycle(g) == false,
...
// ----------------------------------------------------------------------------------------
    ...
    {
        // make sure requires clause is not broken
        IRECLIB_ASSERT(graph_contains_length_one_cycle(g) == false,
        ...
        while (clique.move_next())
        {
            ...
            IRECLIB_ASSERT( x < g.number_of_nodes(), 
                "\tvoid is_clique(g, clique)"
...
// ----------------------------------------------------------------------------------------
    ...
    )
    {
        ...
        IRECLIB_ASSERT(is_clique(g,clique) == true,
            "\tvoid is_maximal_clique(g, clique)"
            << "\n\tinvalid graph"
            );
        clique.reset();
...
// ----------------------------------------------------------------------------------------
    ...
    )
    {
        ...
        IRECLIB_ASSERT(graph_is_connected(g) == true,
            "\tvoid triangulate_graph_and_find_cliques(g, cliques)"
            << "\n\tInvalid graph"
            );
