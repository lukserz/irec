    ...
    class std_allocator 
    {
        /*!
            ...
            WHAT THIS OBJECT REPRESENTS
                ...
                requirements for allocator objects.  The M template argument is one of the ireclib
                memory manager objects and this allocator implementation will do all of its memory allocations
                using whatever ireclib memory manager you supply.   

                Thus, using this allocator object you can use any of the ireclib memory manager objects with
